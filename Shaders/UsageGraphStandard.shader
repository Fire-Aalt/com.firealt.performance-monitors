Shader "Graphy/Usage Graph Standard"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                if (_CautionThreshold >= 0 && _CautionThreshold <= 1 && yCoord < _CautionThreshold && yCoord > _CautionThreshold - 0.02)
                {
                    color = _CautionColor;
                }

                if (_GoodThreshold >= 0 && _GoodThreshold <= 1 && yCoord < _GoodThreshold && yCoord > _GoodThreshold - 0.02)
                {
                    color = _GoodColor;
                }
